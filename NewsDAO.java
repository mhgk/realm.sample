...
public class NewsDAO {
    ...
    private CommentEntity createCommentEntity(News from) {
        ...
        commentEntity.setCreated(from.getCreated().toDate());
    ...
    private NewsEntity createNewsRealm(News from) {
        ...
        to.setCreated(from.getCreated().toDate());
        if (from.getServiceAnnouncementEnd() != null) {
            to.setServiceAnnouncementEnd(from.getServiceAnnouncementEnd().toDate());
            to.setServiceAnnouncementStart(from.getServiceAnnouncementStart().toDate());
        }
